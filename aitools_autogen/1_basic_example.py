...
# Example Task
task = f"""
Write a python function that solves the counting bits problem.  The function should take an integer n as input and return an array of integers from 0 to n where each integer is the number of 1 bits in the binary representation of the integer.
"""
