...
class MLWebAppBlueprint(Blueprint):
    ...
    async def initiate_work(self, message: str):
        ...
        webapp_dev_agent = ConversableAgent("webapp_dev_agent",
            ...
            function_map=None,
            system_message="""  
            You are an expert web development assistant, assisting users in creating full stack web applications using HTML, CSS, React, and node.js.
            ...
            Your task is to generate the necessary UI and backend layers using HTML, CSS, React, and node.js. 
