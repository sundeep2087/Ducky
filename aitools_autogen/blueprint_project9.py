import utils
from agents import WebScraperAgent, WebPageScraperAgent
...
class MLWebAppBlueprint(Blueprint):
    ...
    async def initiate_work(self, message: str):
        ...
        # WebScraper Agent to scrape the datasets
        webscraper_agent = WebScraperAgent()

        # ============================================================================================================ #
        # Summary Agent to summarize the content and generate a structured summary for the web application development #
        # ============================================================================================================ #

        ml_summary_agent = ConversableAgent("ml_summary_agent",
            ...
            5. Web Application Pages and Functionality:
                Summarize the three web pages that need to be created for the web application:
                
                - index.html
                    - This page should provide a detailed overview of the problem, why it is important and the dataset used for training the model.
                     
                - features_and_models.html
                    This page must include:
                    - Detailed explanation of each feature/parameter, its possible values, and its role in the prediction.
                    - Detailed explanation of each model used for solving this problem, how it works in general and its purpose.
                    
                - prediction.html:
                    This page must allow user selection of models and input of parameters:
        ...
        agent0.initiate_chat(webscraper_agent, True, message=message)
        message = webscraper_agent.last_message()
        scraped_content = message["content"]

        agent0.initiate_chat(ml_summary_agent, True, message=scraped_content)
        summary_message = agent0.last_message(ml_summary_agent)

        # ==================================================================================================== #
        # WebApp Development Agent to generate the necessary UI and backend layers using HTML, CSS, JavaScript #
        # ==================================================================================================== #
        ...
        webapp_dev_agent = ConversableAgent("webapp_dev_agent",
            ...
            function_map=None,
            system_message="""  
            You are an expert web development assistant, assisting users in creating full stack web applications using HTML, CSS, and JavaScript.
            ...
            Your task is to generate the necessary files for the UI layer using HTML, CSS, and JavaScript. The JavaScript file must be able to take in all of the user inputs and send request to backend (flask) via an API call. It should also have code to obtain response from backend and return to the frontend.  
        ...
        self._summary_result = "Web application UI generated successfully! Reload the page to view the generated files."
